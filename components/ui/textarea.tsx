...
function Textarea({
  ...
  React.RefAttributes<TextInput> & { variant?: "default" | "memo" }) {
  return (
    <TextInput
      className={cn(
        "flex min-h-16 w-full flex-row rounded-md border border-input px-3 py-2 text-base text-foreground shadow-sm shadow-black/5 dark:bg-input/30 md:text-sm",
